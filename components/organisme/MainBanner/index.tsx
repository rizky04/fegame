        ...
        <div className="row gap-lg-0 gap-5">
            <div className="col-lg-6 col-12 my-auto">
                ...
                <div className="d-flex flex-lg-row flex-column gap-4">
                    <Link className="btn btn-get text-lg text-white rounded-pill" href="#feature" role="button">Get
                        Started</Link>
                    <Link className="btn-learn text-lg color-palette-1 my-auto text-center" href="/#" role="button">Learn
                        More</Link>
                </div>
            </div>
            <Illustration />
